    ...
    <nav class="navbar navbar-expand-lg" style="background-color: #E9A834; color:aliceblue;">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md">
            <div class="row">
                <div class="row d-flex justify-content-center mt-5"><img src="./img/SiLeon TP.png" style="width: 200px; height: 200px;" class="logoo"></div>
                    ...
                    <div class="card my-5 px-2 mx-5 py-5 shadow-lg">
                        <div class="card-body px-3 mb-5 mx-3">
                            ...
                            <div class="mb-3 mt-5">
                                <div class="mb-3 mt-4">
                                    <div class="row ">
                                        <div class="col-md-5"> <label for="inputveri" class=" col-form-label">  Password Baru : </label></div>
                                        <div class="col-md-7 mb-5"> <input style="border: solid black;" type="password"
                                                class="form-control" placeholder="Buat Password Baru"
                                                id="inputPassword"></div>
                                                <div class="col-md-5"> <label for="inputveri" class=" col-form-label">Konfirmasi Password: </label></div>
                                                <div class="col-md-7"> <input style="border: solid black;" type="password"

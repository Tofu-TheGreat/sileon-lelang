...
<section class="topics-section section-padding pb-0" id="section_2">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-8 col-12 mb-4 mb-lg-0">
                <div class="custom-block custom-block-overlay">
                    <a href="detail-mobil.html" class="custom-block-image-wrap">
                        <img src="images/barang/ae86.jpg"
                    ...
                    <div class="custom-block-info custom-block-overlay-info">
                        ...
                        <p class="badge mb-0 fs-5">Rp 90.000.000</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-8 col-12 mb-4 mb-lg-0">
                <div class="custom-block custom-block-overlay">
                    ...
                    <div class="custom-block-info custom-block-overlay-info">
                        ...
                        <p class="badge mb-0 fs-5">Rp 1.500.000</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-8 col-12 mb-4 mb-lg-0">
                <div class="custom-block custom-block-overlay">
                    <a href="detail-kulkas.html" class="custom-block-image-wrap">
                        <img src="images/barang/kulkas.avif"
                            class="custom-block-image img-fluid" alt="">
                    </a>
                    ...
                    <div class="custom-block-info custom-block-overlay-info">
                        ...
                        <p class="badge mb-0 fs-5">Rp 3.000.000</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-8 col-12 mb-4 mb-lg-0">
                <div class="custom-block custom-block-overlay">
                    ...
                    <div class="custom-block-info custom-block-overlay-info">
                        ...
                        <p class="badge mb-0 fs-5">Rp 20.000.000</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-8 col-12 mb-4 mb-lg-0">

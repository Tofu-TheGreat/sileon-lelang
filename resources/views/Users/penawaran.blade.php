        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-3 mt-5 " style="max-width: 350px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="../image_save/" class="img rounded" alt="item">
                        ...
                        <h5 class="card-title">
                            <div class="row-md rounded-1 mb-3" style="background-color: white">
                                ...
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <input style="border: solid black; background-color:white; width:16rem;"
                            ...
                            <form action="{{ route('action.bid') }}" method="post">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="mb-3">
                                        <input style="border: solid black; background-color:white; width:38rem;"
                                            type="number" step="0.01" min="{{ }}"
                                            value="{{ }}" name="harga_akhir" class="form-control"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            @if ($item->harga_akhir >= 110000)
                                                <input style="border: solid black; background-color:white; width:11rem;"
                                                    type="button" disabled class="btn" placeholder="110.000 IDR"
                                                    id="inputPassword">
                                            @elseif($item->harga_akhir < 110000)
                                                <input style="border: solid black; background-color:white; width:11rem;"
                                                    type="button" onclick="change1(110000)" value="110000" class="btn"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            @if ($item->harga_akhir >= 1000000)
                                                <input style="border: solid black; background-color:white; width:11rem;"
                                                    type="button" disabled class="btn" placeholder="1.000.000 IDR"
                                                    id="inputPassword">
                                            @elseif($item->harga_akhir < 1000000)
                                                <input style="border: solid black; background-color:white; width:11rem;"
                                                    type="button" onclick="change2(1000000)" value="1000000" class="btn"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            @if ($item->harga_akhir >= 5000000)
                                                <input style="border: solid black; background-color:white; width:11rem;"
                                                    type="button" disabled class="btn" placeholder="5.000.000 IDR"
                                                    id="inputPassword">
                                            @elseif($item->harga_akhir < 5000000)
                                                <input style="border: solid black; background-color:white; width:11rem;"
                                                    type="button" onclick="change3(5000000)" value="5000000" class="btn"
                                ...
                                <div class="row g-3 align-items-center d-flex justify-content-center">
                                    <button style="border: solid black; background-color:white; width:11rem;" type="submit"
                                        class="form-control mt-5" placeholder="" id="inputPassword">BID!</button>
                                </div>
                            </form>
                        </h5>
                    </div>
